        ...
        <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
            <div className="max-w-6xl mx-auto px-6">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <Link to="/courses" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition">
                            Courses
                        </Link>
            ...
            {isOpen && (
                <div className="md:hidden border-t border-slate-100 bg-white px-6 py-4 space-y-3 shadow-inner">
                    ...
                    <Link to="/courses" className="block text-sm font-medium text-slate-600 hover:text-slate-900 transition py-1">
                        Courses
                    </Link>
